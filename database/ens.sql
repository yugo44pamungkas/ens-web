...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3203958232ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ens&table=users">`ens`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ens&table=careers">`ens`.`careers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=spk&table=kriteria">`spk`.`kriteria`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=spk&table=history">`spk`.`history`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=spk&table=format_setting">`spk`.`format_setting`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=spk&table=ci_sessions">`spk`.`ci_sessions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=spk&table=alters">`spk`.`alters`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ens&table=categories">`ens`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rental_yugo&table=transaksi">`rental_yugo`.`transaksi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rental_yugo&table=user">`rental_yugo`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="544a5b356e2e2531532b305c2b374e3d">
